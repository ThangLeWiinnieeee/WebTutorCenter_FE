...
/**
 * Luồng "nhận lớp" dùng chung cho trang danh sách và trang chi tiết lớp.
 * Kiểm tra lần lượt: đăng nhập → là gia sư → đã có hồ sơ chứng thực →
 * khớp môn/giới tính/trình độ, rồi mở dialog xác nhận tương ứng.
 *
 * @returns {{
 *   receiveDialog: typeof INITIAL_DIALOG & { tutorSubjects?: string[], mismatchReasons?: string[] },
 *   applying: boolean,
 *   openReceive: (classItem: object) => Promise<void>,
 *   confirmApply: () => Promise<void>,
 *   closeDialog: () => void,
 * }}
 */
const useReceiveClass = () => {
